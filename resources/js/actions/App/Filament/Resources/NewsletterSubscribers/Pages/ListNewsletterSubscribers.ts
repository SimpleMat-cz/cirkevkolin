 ...
 */
const ListNewsletterSubscribers = (
 ...
 * @route '/admin/newsletter-subscribers'
 */
ListNewsletterSubscribers.head = (
    options?: RouteQueryOptions,
 ...
 * @route '/admin/newsletter-subscribers'
 */
const ListNewsletterSubscribersForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/admin/newsletter-subscribers'
 */
ListNewsletterSubscribersForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: ListNewsletterSubscribers.url(options),
    method: 'get',
 ...
 * @route '/admin/newsletter-subscribers'
 */
ListNewsletterSubscribersForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
