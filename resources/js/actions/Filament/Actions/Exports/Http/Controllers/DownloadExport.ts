...
const DownloadExport = (
    args:
        | { export: string | number | { id: string | number } }
        | [exportParam: string | number | { id: string | number }]
        | string
        | number
        | { id: string | number },
...
DownloadExport.url = (
    ...
    const parsedArgs = {
        export: typeof args.export === 'object' ? args.export.id : args.export,
    };

    return (
        DownloadExport.definition.url
