...
const allEvents = computed(() => {
    const combined = [...props.events.data, ...props.recurring];
...
<template>
    <Head>
        ...
        <meta
            name="description"
            content="Přehled akcí Apoštolské církve Kolín — neděle, WyldLife, KidzTown, skupinky a další."
        />
    </Head>
                    ...
                    <button
                        ...
                        :class="
                            category === ''
                                ...
                                : 'bg-white text-brand-ink-soft hover:bg-brand-ink/5'
                        "
                        @click="category = ''"
                    >
                        Vše
