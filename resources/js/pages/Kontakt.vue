...
const items = computed(() => [
    {
        icon: MapPin,
        label: 'Adresa',
        value: addressLines.value,
        color: 'bg-brand-coral text-white',
    },
    {
        icon: Mail,
        label: 'E-mail',
        value: site('contact.email', 'kolin@apostolskacirkev.cz'),
        href: `mailto:${site('contact.email', 'kolin@apostolskacirkev.cz')}`,
        color: 'bg-brand-primary text-white',
    },
    {
        icon: Clock,
        label: 'Bohoslužba',
        value: serviceHours.value,
        color: 'bg-brand-teal text-white',
    },
    {
        icon: CreditCard,
        label: 'Účet',
        value: site('contact.bank_account', '435669379 / 0800 (ČS)'),
        color: 'bg-brand-sunny text-brand-ink',
    },
]);
    ...
    <Head>
        ...
        <meta
            ...
            :content="
                ...
                'V Zídkách 402, Kolín. E-mail kolin@apostolskacirkev.cz. Neděle 10:00.'
            "
        />
    </Head>
    ...
    <PublicLayout>
        <PageHero
            ...
            :description="
                ...
                'Jsme dostupní — napiš, zavolej nebo prostě přijď. Nejlíp v neděli v 10:00.'
            "
        />
                ...
                <div class="grid grid-cols-1 gap-10 lg:grid-cols-5">
                    ...
                    <div class="space-y-4 lg:col-span-2">
                        <div
                            ...
                            :key="item.label"
                            :class="[
                                'reveal hover-lift flex gap-5 rounded-3xl bg-brand-cream p-6 ring-1 ring-brand-ink/5',
                                `reveal-delay-${i + 1}`,
                            ]"
                        >
                            <div
                            ...
                            <div class="min-w-0">
                                <p
                                    class="text-xs font-bold tracking-[0.15em] text-brand-ink/50 uppercase"
                                >
                                    {{ item.label }}
                                </p>
                                <template v-if="item.href">
                                    <a
                                        :href="item.href"
                                        class="mt-1 block font-display text-lg text-brand-ink transition-colors hover:text-brand-primary"
                                    >
                                        {{ item.value }}
                                    </a>
                                </template>
                                <p
                                    v-else
                                    class="mt-1 font-display text-lg whitespace-pre-line text-brand-ink"
                                >
                                    {{ item.value }}
                                </p>
                            </div>
                        ...
                        <div
                            v-if="socials.length"
                            class="reveal reveal-delay-5 flex gap-3 pt-2"
                        >
                            <a
                                v-for="s in socials"
                                :key="s.label"
                    ...
                    <div class="reveal reveal-delay-2 lg:col-span-3">
                        <div
                            class="overflow-hidden rounded-3xl shadow-[0_40px_80px_-40px_rgba(42,42,42,0.3)]"
                        >
                            <iframe
            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6">
                <div class="reveal max-w-2xl">
                    ...
                    <p class="mt-4 text-brand-ink-soft">
                        Abys nás poznal(a), když přijdeš poprvé. Hledej
                        prosklený vstup a barevnou tabuli „Vítejte CÍRKEV
                        KOLÍN".
                    </p>
                </div>
                ...
                <div class="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2">
                    <figure
                        class="reveal hover-lift overflow-hidden rounded-3xl bg-white shadow-[0_30px_60px_-30px_rgba(42,42,42,0.25)]"
                    >
                        <img
                        ...
                        />
                        <figcaption
                            class="px-5 py-4 text-sm text-brand-ink-soft"
                        >
                    ...
                    <figure
                        class="reveal reveal-delay-1 hover-lift overflow-hidden rounded-3xl bg-white shadow-[0_30px_60px_-30px_rgba(42,42,42,0.25)]"
                    >
                        <img
