...
Application-specific guidelines are located in the `docs/project_guidelines` directory. These guidelines are specific to this application and may not apply to other Laravel applications. Always check the project guidelines before making changes to ensure you are following the correct conventions and approaches for this application.

Application-specific guidelines take precedence over general Laravel guidelines. If there is a conflict between the two, follow the application-specific guidelines. If you are unsure, ask for clarification.
